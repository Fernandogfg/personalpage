...
const socials = [
  {
    name: 'GitHub',
    url: 'https://github.com/Fernandogfg',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/fernando-gabriel-b219272b2',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: 'Email',
    url: 'mailto:fernandofgfg10@gmail.com',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
